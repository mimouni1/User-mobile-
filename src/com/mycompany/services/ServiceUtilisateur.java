...
public class ServiceUtilisateur {
    ...
    public boolean Register(User u) {
        ...
        String url = ConnectionApi.BASE_URL + "addUserMobile?name=" + u.getUsername()+ "&lastname=" + u.getUserlastname() +"&tel=" + u.getNumTel()+ "&email=" + u.getEmail() + "&password=" + u.getPassword() + "&img_url=" + u.getPhoto();
        req.setUrl(url);
        req.setPost(false);
